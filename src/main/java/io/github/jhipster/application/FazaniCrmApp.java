...
public class FazaniCrmApp {

    private static final Logger log = LoggerFactory.getLogger(FazaniCrmApp.class);

    private final Environment env;

    public FazaniCrmApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes FazaniCRM.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FazaniCrmApp.class);
